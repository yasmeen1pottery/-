        ...
        try {
            ...
            if(unifiedLoginBtn) {
                if(currentUser !== 'guest') {
                    ...
                    unifiedLoginBtn.removeAttribute('data-i18n');
                    unifiedLoginBtn.innerText = currentLang === 'ar' ? `مرحباً، ${shortName}` : `Welcome, ${shortName}`;
                    unifiedLoginBtn.style.background = 'var(--text-primary)';
                    unifiedLoginBtn.style.color = '#fff';
                    
                    const customerHamburgerSpan = document.querySelector('#customerHamburger span');
                    if(customerHamburgerSpan) {
                        customerHamburgerSpan.setAttribute('data-i18n', 'customerHamburgerText');
                        if(translations && translations[currentLang] && translations[currentLang].customerHamburgerText) {
                            customerHamburgerSpan.innerText = translations[currentLang].customerHamburgerText;
                        }
                    }
                } else if (isAdmin) {
                    unifiedLoginBtn.removeAttribute('data-i18n');
                    ...
                    unifiedLoginBtn.setAttribute('data-i18n', 'login');
                    if(translations && translations[currentLang] && translations[currentLang].login) {
